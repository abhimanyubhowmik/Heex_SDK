...
set(HEEX_UTILS_BOOST_DEPS log_setup log filesystem) # NOTE: Order is important. Linking can failed otherwise due to log dependence to filesystem.

## Add extra dependencies depending on builds
if (legacy1804HeexSdk OR HEEX_BOOST_VERSION VERSION_LESS 1.75.0)
  message(STATUS "Using Boost ${HEEX_BOOST_VERSION} libs for Ubuntu/Linux 18.04 (legacy1804HeexSdk)")
  set(HEEX_UTILS_BOOST_DEPS ${HEEX_UTILS_BOOST_DEPS} date_time)
endif()
...
if(EXISTS ${HEEX_3RDPARTY_DIR}/${HEEX_BOOST_FOLDER_NAME}/)
  ...
  find_package(Boost ${HEEX_BOOST_VERSION} COMPONENTS ${HEEX_UTILS_BOOST_DEPS} REQUIRED)
else()

...
public:
  ...
  std::unordered_map<std::string, bool> _isOn; // NOLINT: Allow '_' prefix on public member, because cannot rename or set in protected due to backwards compatibility tests
};

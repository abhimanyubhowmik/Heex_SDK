...
message(STATUS "Looking for HeexCom version " 2.39.1)
find_package(HeexCom 2.39.1 REQUIRED PATHS ${HEEX_LIBRARIES_DIR}/HeexCom/build/ NO_DEFAULT_PATH)
message(STATUS "HeexCom_DIR=${HeexCom_DIR}")

message(STATUS "Looking for HeexConfig version " 2.39.1)
find_package(HeexConfig 2.39.1 REQUIRED PATHS ${HEEX_LIBRARIES_DIR}/HeexConfig/build/ NO_DEFAULT_PATH)
message(STATUS "HeexConfig_DIR=${HeexConfig_DIR}")

message(STATUS "Looking for HeexMessages_DIR version " 2.39.1)
find_package(HeexMessages 2.39.1 REQUIRED PATHS ${HEEX_LIBRARIES_DIR}/HeexMessages/build/ NO_DEFAULT_PATH)

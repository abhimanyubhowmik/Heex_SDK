    ...
    std::vector<Heex::RecorderArgs::ContextValue>& contextValues)
{
  ...
  double latitude = 48.8580644;
  double longitude = 2.3850982;
...
bool Heex::GetStarted::GetStartedRecorder::generateRequestedFilePaths(const Heex::RecorderArgs::RecorderEventRecordingPartArgs& /*query*/, std::string& filepath)
{
  ...
  filepath = "/home/abhimanyu/Documents/Heex_SDK_2_37_1/test.txt";
  return true;
}
...
int main()
{
  ...
  const std::string recorderUuid = "R-db7ee743-7104-4ebb-878f-7c8ea6d7b8d1(1.0.0)";
